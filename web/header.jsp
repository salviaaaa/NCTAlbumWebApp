...
<body>
    ...
    <header>
        <div class="top-bar">
            <a href="index.jsp" class="author-link">NCT </a>
            <div class="navbar">
                <nav>
                     <form id="searchForm" action="SearchServlet" method="GET" class="search-container" onsubmit="performSearch(event)">
                        <input type="search" id="search-input" name="query" class="form-control" placeholder="Search Album" onkeyup="getSearchSuggestions(this.value)">
                        <button type="submit">
                    ...
                    <a href="allalbumlist.jsp" class="navtext">All album</a>
                    <a href="cart.jsp" class="navtext">Cart</a>
                    <a href="TranshistoryServlet" class="navtext">Order</a>
                    ...
                    <% } else { %>
                        ...
                        <% } else { %>
                            <a href="signin.jsp" class="navtext">SignIn</a>
                        <% } %>
                    <% } %>
                </nav>
            </div>
