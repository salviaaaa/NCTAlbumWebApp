                ...
                <div class="card-body">
                   ...
                   <div class="info-group">
                    ...
                    <div class="btn-group-custom">
                        ...
                        <button type="button" class="btn btn-custom-red" onclick="confirmLogout()">SignOut</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="logoutModalLabel">SignOut Confirmation</h5>
            ...
            <div class="modal-footer">
                ...
                <a href="SignOutServlet" class="btn btn-custom-red">SignOut</a>
            </div>
        </div>
    </div>
</div>
