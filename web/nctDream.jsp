    ...
    <section>
        <div id="head-fantasy">
            <h2 class="heading">
              ...
              <p class="subUnit-description" >NCT Dream is a sub-unit of NCT consisting of younger members. They are known for their fresh and cheerful concepts that often change depending on the age of the members.</p>
  <br>
              <div class="album-details-container">
            <% for (AlbumBean album : albums) { 
                if (album.getSubUnit().equals("Nct Dream")) { %>
