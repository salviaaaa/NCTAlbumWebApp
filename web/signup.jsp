...
<head>
    ...
    <style>
        ...
        html, body {
            ...
            background: url('https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQY6zo_GIqvCnHGmo3VDBbzUKD4D02dFXgPYAiXOjQ9Jj-N8ubyKWlFYLVBsDzO') no-repeat center center fixed;
        ...
        <div class="nav">
            <ul class="links text-center">
                <li class="signin-active">
                    <span style="color: black; font-weight: bold; text-transform: uppercase; font-size: 18px;">SignUp</span>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <form action="SignUpServlet" method="post" onsubmit="return validateForm();">
                ...
                <div class="sign-up">Have an account ? <a href="signin.jsp">Click Here</a></div>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="window.location.href='signin.jsp';">Go to SignIn</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="errorModal" tabindex="-1" aria-labelledby="errorModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="errorModalLabel">SignUp Failed</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
